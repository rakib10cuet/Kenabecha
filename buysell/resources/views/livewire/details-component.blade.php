                    ...
                    <div class="detail-info">
                        ...
                        @if($product->salePrice > 0)
                            <div class="wrap-price">
                                ...
                                <del><span class="product-price regprice">${{$product->regularPrice}}</span></del>
                            </div>
                        @else
                        ...
                        <div class="stock-info in-stock">
                            <p class="availability">Availability: <b>{{$product->stockStatus}}</b></p>
                        </div>
                        <div class="quantity">
                            <span>Quantity:</span>
                                ...
                                <li class="product-item">
                                    <div class="product product-widget-style">
                                        ...
                                        <div class="product-info">
                                            ...
                                            @if($p_product->salePrice > 0 && !empty($sale) &&  $sale->status == 1 && $sale->saleDate > Carbon\Carbon::now())
                                                <div class="wrap-price">
                                                    <span class="product-price">${{$p_product->salePrice}}</span>
                                                    <del><span class="product-price regprice">${{$p_product->regularPrice}}</span></del>
                                                </div>
                                            @else
                                                <div class="wrap-price"><span class="product-price">${{$product->regularPrice}}</span></div>
                                            @endif
                            ...
                            @foreach($related_product as $r_product)
                                <div class="product product-style-2 equal-elem ">
                                    ...
                                    <div class="product-info">
                                        ...
                                        @if($r_product->salePrice > 0 && !empty($sale) &&  $sale->status == 1 && $sale->saleDate > Carbon\Carbon::now())
                                            <div class="wrap-price">
                                                <span class="product-price">${{$r_product->salePrice}}</span>
                                                <del><span class="product-price regprice">${{$r_product->regularPrice}}</span></del>
                                            </div>
                                        @else
                                            <div class="wrap-price"><span class="product-price">${{$r_product->regularPrice}}</span></div>
                                        @endif
                                    </div>
                                </div>
                            @endforeach
