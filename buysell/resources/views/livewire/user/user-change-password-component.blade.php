                    ...
                    <div class="panel-body">
                        ...
                        <form class="form-horizontal" wire:submit.prevent="changePassword">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input type="text" placeholder="New Password" class="form-control input-md" name="password" wire:model="password">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input type="text" placeholder="Confirm Password" class="form-control input-md" name="confirmPassword" wire:model="password_confirmation">
